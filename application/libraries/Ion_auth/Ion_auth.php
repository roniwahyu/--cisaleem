...
class Ion_auth
{
    ...
    //development to saleem thesis requirement that store username password to another users1 to users5
    public function batchregister($username, $password, $email, $additional_data = array(), $group_ids = array()) //need to test email activation
    {
        $this->ion_auth_model->trigger_events('pre_account_creation');
        ...
        {
            $id = $this->ion_auth_model->register($username, $password, $email, $additional_data, $group_ids);
            $id = $this->ion_auth_model->batchregister($username, $password, $email, $additional_data, $group_ids);
